...
CREATE TABLE jobs (job_id uuid PRIMARY KEY, job_type varchar(80) NOT NULL, state varchar(20) NOT NULL DEFAULT 'queued', payload jsonb NOT NULL, result jsonb, lease_owner varchar(200), lease_expires_at timestamptz, attempt_count integer NOT NULL DEFAULT 0, max_attempts integer NOT NULL DEFAULT 3, error text, created_at timestamptz NOT NULL DEFAULT now(), started_at timestamptz, completed_at timestamptz);
