...
**Status:** planned milestone gate. **Owner:** security/reliability acceptance.
**Depends on:** R28–R31.
...
raw genomic payloads; every malicious case has a stable auditable rejection. Milestone
E is incomplete until this gate passes.
