...
Deterministic code owns scientific truth. Jev owns bounded semantic judgment.
Research agents own proposals. Versioned CancerJev policy connects these authorities
without allowing one to impersonate another.
...
2. **Deterministic discovery:** versioned engines, tested universes, Findings, and
   reproduction.
...
CJ-R09–R15 add cross-modal/covariate and survival engines, immutable Findings,
SearchRun/CandidateObservation, one JevService and Semantic Ledger, typed
CandidateState, and bounded adaptive discovery.

Exit: deterministic candidates can be reproduced, semantically evaluated, and
expanded within explicit public-data and cost budgets.
...
CJ-R26–R27 deliver the researcher cockpit and exact handoff/review packages.
